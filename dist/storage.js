import { MEMORY_DIR, CATEGORIES, categoryPath, memoryFilePath } from "./paths";
...
export async function readMemory(relPath) {
...
export async function saveMemory(category, title, body, options = {}) {
...
async function readMemoryFromPath(filePath) {
...
export async function deleteMemory(relPath) {
    const fullPath = join(MEMORY_DIR, relPath);
...
export function getCategoryFromPath(relPath) {
